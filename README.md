...
1. The core features of Node.js and Express and why they are useful.
   It's easier then using the old way(http). Plus express let's you custom your api's.
2. Understand and explain the use of Middleware. To effect a api call inside the call of the api.
3. The basic principles of the REST architectural style. CRUD Create/Read/Update/Delete
4. Understand and explain the use of Express Routers. Creating a custom router to use for CRUD.
5. Describe tooling used to manually test the correctness of an API. Httpie http post :6000/api/projects/id: or postman
